...
module RuboCop
  module Cop
    module Style
      ...
      # the default value of `ENV.fetch`. The autocorrect behavior when the RHS is
      # a basic literal object (e.g., 'string', :symbol, true, 1) is configurable
      # via the `BasicLiteralRhs` option.
